...
<div class="page page_submissions">
	...
	<div class="cmp_notification">
     ...
     <ul id="subs-nav">
          <li><a href="#subs-checklist">Proposal Preparation Checklist</a></li>
          <li><a href="#authorGuidelines">Proposal Guidelines</a>
               <ul>
                    <li><a href="#subs-review">Proposal Review Process</a></li>
                    <li><a href="#subs-instructions">Proposal Submission Instructions</a></li>
                    <li><a href="#subs-costs">Costs</a></li>
               </ul>
          </li>
	...
	{if $currentContext->getLocalizedData('copyrightNotice')}
		<div class="copyright_notice" id="copyright">
			<h2>
